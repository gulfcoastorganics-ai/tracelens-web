...
const app = read("web/app.js"); const html = read("web/index.html"); const sw = read("web/sw.js"); const release = read("scripts/release-check.mjs");
...
test("Ghost Brush controls and module are integrated", () => {
  ...
  assert.match(sw, /ghost-brush\.js/); assert.match(release, /web\/ghost-brush\.js/);
});
