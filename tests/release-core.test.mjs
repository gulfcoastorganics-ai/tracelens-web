...
assert.match(sw, /hand-tracker\.js/);
assert.match(sw, /trace-guide\.js/);
...
assert.match(app, /AppStateMachine/);
assert.match(app, /normalizeFeatureFlags/);
assert.match(sw, /app-state-machine\.js/);
assert.match(sw, /feature-flags\.js/);
assert.match(sw, /guided-tracing\.js/);
assert.match(sw, /comparison\.js/);
assert.match(app, /completeStep/);
assert.match(app, /compareFinishedDrawing/);
assert.match(app, /addRegion/);
assert.match(app, /sessionReplay/);
assert.match(sw, /regions\.js/);
assert.match(sw, /session-replay\.js/);
