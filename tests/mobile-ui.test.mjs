...
for (const id of ["quickTraceBar", "quickOriginalButton", "quickAssistButton", "quickTraceExpandButton", "traceModeChips", "traceDetailInput", "tracePriorityInput", "traceQuality", "layersToggle", "adjustSheet"]) assert.ok(html.includes(`id="${id}"`), `missing ${id}`);
